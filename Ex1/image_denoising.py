...
G= [[1,2,1],
    [2,4,2],
    [1,2,1]] #trial matrix
u, s, vh= np.linalg.svd(g, full_matrices=True, compute_uv=True, hermitian=False)
...
gflt_imns= conv1(imns,v, axis=0)
gflt_imns= conv1(gflt_imns,h,axis=1)

gflt_imng= conv1(imng,v, axis=0)
gflt_imng= conv1(gflt_imng,h,axis=1)
